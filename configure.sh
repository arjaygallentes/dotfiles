...
echo ''
read -p "Do you want to use arjay's dotfiles? y/n" -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    echo ''
	echo "Now pulling down arjay's dotfiles..."
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with arjay's dotfiles..."
    else
        echo "arjay's dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply arjay's dotfiles. You will need to configure your environment manually..."
	echo ''
