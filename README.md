# arjay does dotfiles - forked from jldeen's repo

### WSL Configuration / Install
Run the following to configure WSL from scratch...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/arjaygallentes/dotfiles/wsl/configure.sh)"
```
### WSL Emulator Install
Run the following command from an Administrator PowerShell prompt...
```
Set-ExecutionPolicy Bypass; irm 'https://raw.githubusercontent.com/arjaygallentes/dotfiles/wsl/wslterm.ps1' | iex;
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork mine](https://github.com/arjaygallentes/dotfiles/fork), remove what you don't
...
```sh
git clone https://github.com/arjaygallentes/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
